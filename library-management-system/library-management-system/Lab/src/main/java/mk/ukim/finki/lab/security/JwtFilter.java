package mk.ukim.finki.lab.security;
...
import mk.ukim.finki.lab.service.domain.impl.UserServiceImpl;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    public JwtFilter(JwtHelper jwtHelper, UserServiceImpl userService) {
